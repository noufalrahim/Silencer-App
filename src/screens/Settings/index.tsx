...
export default function Settings() {
  ...
  React.useEffect(() => {
    if (error) {
      Alert.alert(
        'Permission',
        'Do not disturb permission is required. Please grant the permission from settings.',
      );
    }
  }, [error]);
  ...
  React.useEffect(() => {
    ...
    handleModeChange();
  }, [selected.id, selected.mode, setMode]);
  ...
  const settingsTitles = [
    ...
    },
    {
      ...
      onPress: () => {
        Alert.alert(
          'About',
          "Silencer App is a simple app to manage your phone's ringer mode. \n\n© 2024 NOUFAL RAHIM. \n\nALL RIGHTS RESERVED.",
        );
        console.log('About');
      },
    ...
    },
    {
      ...
      onPress: () => {
        Alert.alert(
          'Help',
          'If you have any queries or need help, please contact me at noufalrahim6784@gmail.com',
        );
        console.log('Help');
      },
